<?php
    ...
    $config['photo']['photo_static'][$nametype]['height'] = 435;
    $config['photo']['photo_static'][$nametype]['thumb'] = '1366x435x1';
    ...
    $config['photo']['photo_static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['width'] =  214;
    $config['photo']['photo_static'][$nametype]['height'] = 214;
    $config['photo']['photo_static'][$nametype]['thumb'] = '214x214x1';
    $config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
    ...
    $config['photo']['man_photo'][$nametype]['height_photo'] = 674;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '1366x674x1';
